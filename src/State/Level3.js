...
Platformer.State.Level3 = function (game) {
  this.config;
  this.data;
  this.player;
  this.tilemap;
...
Platformer.State.Level3.prototype = {
  ...
  create: function () {
    ...
    this.tilemap.setCollisionBetween(33, 34);
    this.tilemapLayer = this.tilemap.createLayer('Tile Layer 1');
  ...
  update: function () {
    ...
    this.physics.arcade.collide(this.player, this.tilemapLayer);
    this.physics.arcade.collide(this.stars, this.tilemapLayer);
